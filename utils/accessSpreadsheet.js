...
module.exports = async(options)=>{
    try{
        const doc = new GoogleSpreadsheet(process.env.spreadsheetId||'19rXQmvB7vnbb4vpCyqsD0-qzU2h_3CU4bGt08fadYTQ');
        await doc.useServiceAccountAuth({
            client_email: process.env.client_email||"sheeets@big-cargo-274413.iam.gserviceaccount.com",
